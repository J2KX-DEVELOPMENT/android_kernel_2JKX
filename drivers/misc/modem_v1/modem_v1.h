...
#define mif_err(fmt, ...) \
	pr_no_err(LOG_TAG "%s: " pr_fmt(fmt), __func__, ##__VA_ARGS__)
#define mif_debug(fmt, ...) \
	pr_no_debug(LOG_TAG "%s: " pr_fmt(fmt), __func__, ##__VA_ARGS__)
#define mif_info(fmt, ...) \
	pr_no_info(LOG_TAG "%s: " pr_fmt(fmt), __func__, ##__VA_ARGS__)
