...
static gpu_dvfs_info gpu_dvfs_table_default[] = {
	{MAX_FREQ, 900000, 0, 98, 100, 5, 0, 666000, 467000, 0, CPU_MAX},
	{666, 900000, 0, 98,  99, 3, 0, 666000, 467000, 0, CPU_MAX},
	{553, 900000, 0, 90,  99, 5, 0, 666000, 467000, 0, CPU_MAX},
	{415, 900000, 0, 70,  98, 3, 0, 415000, 467000, 0, CPU_MAX},
	{MIN_FREQ, 850000, 0, 10,  88, 1, 0, 150000, 467000, 0, CPU_MAX},
};

static int mif_min_table[] = {
	MAX_FREQ2, 700000, 666000, 415000, MIN_FREQ2,
};

static gpu_attribute gpu_config_attributes[] = {
	{GPU_MAX_CLOCK, MAX_FREQ},
	{GPU_MAX_CLOCK_LIMIT, MAX_FREQ},
	{GPU_MIN_CLOCK, MIN_FREQ},
	{GPU_DVFS_START_CLOCK, 250},
	{GPU_DVFS_BL_CONFIG_CLOCK, 666},
	{GPU_GOVERNOR_TYPE, G3D_DVFS_GOVERNOR_INTERACTIVE},
	{GPU_GOVERNOR_START_CLOCK_DEFAULT, MIN_FREQ},
	{GPU_GOVERNOR_START_CLOCK_INTERACTIVE, 666},
	{GPU_GOVERNOR_START_CLOCK_STATIC, 666},
	{GPU_GOVERNOR_START_CLOCK_BOOSTER, 666},
	...
	{GPU_GOVERNOR_INTERACTIVE_HIGHSPEED_CLOCK, HIGHSPEED_FREQ},
	{GPU_GOVERNOR_INTERACTIVE_HIGHSPEED_LOAD, HIGHSPEED_LOAD},
	{GPU_GOVERNOR_INTERACTIVE_HIGHSPEED_DELAY, 0},
	{GPU_DEFAULT_VOLTAGE, 900000},
	{GPU_COLD_MINIMUM_VOL, 0},
	{GPU_VOLTAGE_OFFSET_MARGIN, 25000},
	{GPU_TMU_CONTROL, 0},
	{GPU_TEMP_THROTTLING1, MAX_FREQ},
...
#endif
	{GPU_RUNTIME_PM_DELAY_TIME, 15},
	{GPU_DVFS_POLLING_TIME, 30},
	{GPU_PMQOS_INT_DISABLE, 1},
	{GPU_PMQOS_MIF_MAX_CLOCK, MAX_FREQ2},
	{GPU_PMQOS_MIF_MAX_CLOCK_BASE, 666},
	{GPU_CL_DVFS_START_BASE, MAX_FREQ},
	{GPU_DEBUG_LEVEL, DVFS_WARNING},
	{GPU_TRACE_LEVEL, TRACE_ALL},
	{GPU_MO_MIN_CLOCK, MAX_FREQ},
	{GPU_SUSTAINABLE_GPU_CLOCK, MAX_FREQ},
