...
static struct fimc_is_sensor_cfg config_imx260[] = {
	...
	/* 2016x1134@120fps */
	FIMC_IS_SENSOR_CFG_EXT(2016, 1134, 120, 45, 4, CSI_DATA_LANES_4, 2145),
	/* 2016x1134@240fps */
	FIMC_IS_SENSOR_CFG_EXT(2016, 1134, 240, 45, 5, CSI_DATA_LANES_4, 2145),
	/* 1008x 756@120fps */
	FIMC_IS_SENSOR_CFG_EXT(1008,  756, 120, 45, 6, CSI_DATA_LANES_4, 2145),
	/* 2016x 1512@30fps */
