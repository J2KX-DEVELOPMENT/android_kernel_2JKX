...
int cis_3p3_probe(struct i2c_client *client,
...
static int cis_3p3_remove(struct i2c_client *client)
{
	int ret = 0;
	return ret;
}

static const struct of_device_id exynos_fimc_is_cis_3p3_match[] = {
	{
		.compatible = "samsung,exynos5-fimc-is-cis-3p3",
	},
	{},
};
MODULE_DEVICE_TABLE(of, exynos_fimc_is_cis_3p3_match);

static const struct i2c_device_id cis_3p3_idt[] = {
	{ SENSOR_NAME, 0 },
	{},
};

static struct i2c_driver cis_3p3_driver = {
	.driver = {
		.name	= SENSOR_NAME,
		.owner	= THIS_MODULE,
		.of_match_table = exynos_fimc_is_cis_3p3_match
	},
	.probe	= cis_3p3_probe,
	.remove	= cis_3p3_remove,
	.id_table = cis_3p3_idt
};
module_i2c_driver(cis_3p3_driver);
