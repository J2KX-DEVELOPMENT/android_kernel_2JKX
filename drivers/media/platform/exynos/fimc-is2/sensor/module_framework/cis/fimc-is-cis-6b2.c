...
static int cis_6b2_remove(struct i2c_client *client)
{
	int ret = 0;
	return ret;
}

static const struct of_device_id exynos_fimc_is_cis_6b2_match[] = {
	{
		.compatible = "samsung,exynos5-fimc-is-cis-6b2",
	},
	{},
};
MODULE_DEVICE_TABLE(of, exynos_fimc_is_cis_6b2_match);
...
static struct i2c_driver cis_6b2_driver = {
	.driver = {
		.name	= SENSOR_NAME,
		.owner	= THIS_MODULE,
		.of_match_table = exynos_fimc_is_cis_6b2_match
	},
	.probe	= cis_6b2_probe,
	.remove	= cis_6b2_remove,
	.id_table = cis_6b2_idt
};
module_i2c_driver(cis_6b2_driver);
