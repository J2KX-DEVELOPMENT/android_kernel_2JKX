...
#define mfc_debug(fmt, args...)	do {} while(0)

#define mfc_debug_enter() 	do {} while(0)
#define mfc_debug_leave()	do {} while(0)

#define mfc_err(fmt, args...)	do {} while(0)

#define mfc_err_dev(fmt, args...)	do {} while(0)

#define mfc_err_ctx(fmt, args...)	do {} while(0)

#define mfc_info_dev(fmt, args...)	do {} while(0)

#define mfc_info_ctx(fmt, args...)	do {} while(0)
